...
export interface ApiDealsProductDealsProduct extends Schema.CollectionType {
  collectionName: 'deals';
  info: {
    singularName: 'deals-product';
    pluralName: 'deals';
    displayName: 'Deals';
  };
  options: {
  ...
  attributes: {
    name: Attribute.Text;
    originalPrice: Attribute.Text;
    price: Attribute.String;
    imageUrl: Attribute.Media;
    productId: Attribute.UID<'api::deals-product.deals-product', 'name'>;
    unitCapitity: Attribute.Text;
    unitPrice: Attribute.String;
    Upc: Attribute.Text;
    ...
    createdBy: Attribute.Relation<
      'api::deals-product.deals-product',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiDepartmentProductDepartmentProduct
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    title: Attribute.Relation<
      'api::department-product.department-product',
      'oneToMany',
...
export interface ApiProductsListProductsList extends Schema.CollectionType {
  collectionName: 'products';
  info: {
    singularName: 'products-list';
    pluralName: 'products';
  ...
  attributes: {
    name: Attribute.Text;
    productId: Attribute.UID<'api::products-list.products-list', 'name'>;
    price: Attribute.String;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::deals-product.deals-product': ApiDealsProductDealsProduct;
